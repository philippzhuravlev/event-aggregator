...
// Request validation covers several aspects:
// 1. Content-Type Validation: Ensures the request has an acceptable Content-Type header.
// 2. Body Size Validation: Checks that the request body does not exceed specified size limits.
// 3. JSON Structure Validation: Validates the request body against a JSON schema.
// 4. HTTP Method Validation: Ensures the request method is allowed for the endpoint.
 ...
 */
export function getHeader(request: Request, headerName: string): string | null {
